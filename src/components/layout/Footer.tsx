...
import { Instagram, Twitter } from 'lucide-react'; // Assuming you have lucide-react

// A simple TikTok icon component if you don't have one
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex mt-4 space-x-6">
                <a href="#" className="hover:text-white transition-colors"><span className="sr-only">Instagram</span><Instagram size={24} /></a>
                <a href="#" className="hover:text-white transition-colors"><span className="sr-only">TikTok</span><TikTokIcon className="w-6 h-6" /></a>
                <a href="#" className="hover:text-white transition-colors"><span className="sr-only">Twitter</span><Twitter size={24} /></a>
            </div>
          </div>
